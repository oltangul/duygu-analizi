<template>
  <div class="login">
    ...
    <section class="banner">
      ...
      <div class="container">
        <h1 class="banner-title animate__animated animate__fadeIn">Giriş Yap</h1>
        <p class="banner-description animate__animated animate__fadeInUp animate__delay-1s">
          Hesabınıza giriş yaparak duygusal yolculuğunuza devam edin
        </p>
      </div>
    </section>
        ...
        <div class="form-container animate__animated animate__fadeInUp">
          <form @submit.prevent="handleLogin" class="login-form">
            ...
            <div class="form-footer">
              <p>
                Hesabınız yok mu?
                <router-link to="/register" class="register-link">Kayıt olun</router-link>
              </p>
            </div>
          </form>
        </div>
...
const handleLogin = async () => {
    try {
        ...
        error.value = 'Giriş yapılamadı. Lütfen bilgilerinizi kontrol edin.'
    } finally {
        loading.value = false
    }
}
